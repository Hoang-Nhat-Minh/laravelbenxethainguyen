          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block"
                style="background-image: url('img/forgot-password.jpg'); background-size: cover;"></div>
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-2">Quên mật khẩu?</h1>
                    <p class="mb-4">Mời bạn điền tài khoản email của bạn để chúng tôi cung cấp đường
                      link đặt mật khẩu mới!</p>
                  </div>
                  <form class="user">
