...
@section('content')
  <div class='snippet-body m-5 p-5'>
    <form action="{{ route('fix-up-profile', ['userdata' => $userdata]) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
          ...
          <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
              <label for="image">Thay ảnh đại diện:</label><br>
              <input class="btn btn-dark" style="width:300px;" type="file" accept="image/*" name="avatar">
              <img src="{{ asset('Pictures/upFormWeb/' . $userdata->avatar) }}" class="rounded-circle mt-5 outputImg"
